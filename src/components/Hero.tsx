...
export default function Hero() {
  ...
  return (
    <div className="relative w-full h-[100dvh] bg-[#1a2426] flex items-center justify-center overflow-hidden">
      <div 
        className="relative w-full aspect-[2835/3544]"
        style={{ maxHeight: '100dvh', maxWidth: 'calc(100dvh * (2835 / 3544))' }}
      >
        {/* LAYER 1 - Background */}
        ...
        <div className="absolute inset-0 z-30 pointer-events-none">
          <motion.div
            ...
            className="absolute bottom-[4%] md:bottom-[5%] left-1/2 -translate-x-1/2 pointer-events-auto"
          >
            <button 
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 md:h-48 bg-gradient-to-t from-[#263336] to-transparent z-20 pointer-events-none" />
    </div>
  );
}
